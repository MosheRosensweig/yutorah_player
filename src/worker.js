...
const PWA_MANIFEST = {
  ...
  icons: [
    {
      src: "/icons/icon-shield-192.png?v=6",
      sizes: "192x192",
      type: "image/png",
      purpose: "any"
    },
    {
      src: "/icons/icon-shield-512.png?v=6",
      sizes: "512x512",
      type: "image/png",
      purpose: "any"
    }
...
const PWA_ICON_192_BASE64 = "";
const PWA_ICON_512_BASE64 = "";
...
const CACHE_NAME = 'yutorah-pwa-v6';
const PRECACHE_URLS = [
  '/',
  '/manifest.json?v=6',
  '/icons/icon-shield-192.png?v=6',
  '/icons/icon-shield-512.png?v=6'
];
...
<head>
  ...
  <link rel="icon" type="image/png" href="/icons/icon-shield-192.png?v=6">
  ...
  <link rel="apple-touch-icon" href="/icons/icon-shield-192.png?v=6">
  <link rel="apple-touch-icon" sizes="192x192" href="/icons/icon-shield-192.png?v=6">
  <link rel="apple-touch-icon" sizes="512x512" href="/icons/icon-shield-512.png?v=6">
  <script>
    (function() {
      try {
